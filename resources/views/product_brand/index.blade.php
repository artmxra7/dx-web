    ...
    <div class="m-content">
        ...
        <div class="m-subheader" style="padding:0px;margin-bottom:20px;">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">Product Brand</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="{{ url('/product-brand') }}" class="m-nav__link">
                                <span class="m-nav__link-text">Product Brand</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        ...
                        <a href="{!! route('product-brands.create') !!}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                            <span>
    ...
    <script>
            $(document).ready(function(){
               ...
               $('#table_data').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:'{{ route('datatable_product_brand') }}',
                    },
                    columnDefs: [
                            {
                               targets: 0 ,
